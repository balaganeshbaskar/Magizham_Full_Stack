		...
		<div class="row" style="height: 60px; border: 2px solid #E8E8E8; border-radius: 5px; padding-top: 10px;">
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="row"> 
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<input class="form-control" type="text" id="namesearch" onkeyup="searchfun()" placeholder="Name" title="Search students using their name">
					</div>	
				</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="row"> 	
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<input class="form-control" type="number" id="rollnosearch" onkeyup="searchfun()" placeholder="Roll Number" title="Search using rollnumber">
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<input class="form-control" type="number" id="attsearch" onkeyup="searchfun()" placeholder="Attendance" title="Shows students with attendance above entered value">
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				...
				<thead>
					<tr style="background-color: #E8E8E8; height: 50px;">
						<th style="vertical-align: middle; text-align: center; width: 5%;">
							<?php if($intro_classteacher == 'yes'):?>
								<input type="checkbox" name="rowss" style="height: 18px; width: 18px;" onchange="select_all(this)">
							<?php endif; ?>
						</th>
						...
						<th style="vertical-align: middle; text-align: center; border-left: 1px solid lightgrey; width: 10%;">Father Name</th>
						<th style="vertical-align: middle; text-align: center; border-left: 1px solid lightgrey; width: 10%;">Attendance</th>
						<th style="vertical-align: middle; text-align: center; border-left: 1px solid black; width: 10%;">Action</th>
					</tr>
				</thead>
				<tbody>
